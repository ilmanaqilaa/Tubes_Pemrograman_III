...
class Transaction_model extends CI_model
{
    ...
    public function getDataTransaction($transaction_id)
    {
        ...
        if($transaction_id){
            ...
            $this->db->select('transaction_id, book.book_name, book_type_name, publisher_name, officer.officer_name, rack.rack_name, borrower.name, book.book_id, officer.officer_id, borrower.borrower_id, borrow_date, return_date, status');
