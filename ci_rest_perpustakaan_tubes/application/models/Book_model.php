...
class Book_model extends CI_model
{
    ...
    public function getDatabook($book_id)
    {
        ...
        if($book_id){
            ...
            $this->db->select('book_id, book_name, book_type_name, page, rack_name,  publisher.publisher_id, publication_year, publisher_name, book_type.book_type_id, rack.rack_id');
